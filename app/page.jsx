...
// ✅ Updated FeatureCard with increased width and optional className
function FeatureCard({ icon, title, description, href, className }) {
  return (
    <Card className={`w-full md:w-[360px] h-[420px] flex flex-col items-center text-center p-6 hover:cursor-pointer shadow-lg rounded-lg transition-transform transform hover:scale-105 ${className}`}>
